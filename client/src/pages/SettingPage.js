        ...
        <Grid container>
            <Grid item xs={4} className={classes.leftPanel}>
                <Typography variant="h3" align="left" >
                    Settings<FontAwesomeIcon icon={faCog} className={classes.icon} size="xs"/>
                </Typography>
                <Tabs 
                    ...
                    >
                        <Tab label="Company" classes={{
                            wrapper: classes.wrapper,
                            selected: classes.selected}}/>
                        <Tab label="Security" classes={{
                            wrapper: classes.wrapper,
                            selected: classes.selected
                        }}
                            to='/security' component={Link}/>
                        <Tab label="Log out" classes={{
                            wrapper: classes.wrapper,
                            selected: classes.selected
                            }} 
